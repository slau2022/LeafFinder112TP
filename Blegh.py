...
def compareOutlines(leaf1, leaf2):
    ...
    img, cont, hierarchy = cv2.findContours(edges,cv2.RETR_TREE, cv2.CHAIN_APPROX_NONE)
    img2, cont2, hierarchy2 = cv2.findContours(edges2,cv2.RETR_TREE, cv2.CHAIN_APPROX_NONE)
...
def analyzeLeaf(leaf):
    img = "LeafShapescopy/Sinuate/oak2.jpg"
